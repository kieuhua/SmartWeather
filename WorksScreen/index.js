...
class WorksScreen extends Component {
    static displayName = "WorksScreen"
    static navigationOptions = {
        headerTitle: <LogoTitle name="Works"/>,
    ...
    render() {
        return (
            <ScrollView>
                {this._mkMembersView()}              
                <Button onPress={() => this.props.navigation.navigate('NewMember', {categoryID: 3})} title="Add Member" />                
            </ScrollView>
        )
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps) (WorksScreen)
